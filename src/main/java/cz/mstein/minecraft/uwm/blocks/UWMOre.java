...
public class UWMOre extends UWMBlock {
	Item toDrop;
	int minDropAmount = 1;
	int maxDropAmount = 3;
	public UWMOre(String name, Material material, Item toDrop, int minDropAmount, int maxDropAmount) {
		super(name, Material.ROCK);
		this.toDrop = toDrop;
		this.minDropAmount = minDropAmount;
		this.maxDropAmount = maxDropAmount;
	}
	public UWMOre(String name, Material material) {
		this(name, material, null, 1, 1);
	}
	
	public UWMOre(String name, Material material, Item toDrop) {
		this(name, material, toDrop, 1, 1);
	}
	
	public UWMOre(String name, Material material, Item toDrop, int dropAmount) {
